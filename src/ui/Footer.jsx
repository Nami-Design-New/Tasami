        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-4 col-md-6 col-12 p-2">
            ...
            <p className="description">
              نحن منصة عربية نسعى لربط الأفكار بأصحاب المهارات والخبرات من خلال بيئة داعمة وموثوقة. هدفنا تمكينك من إنجاز مشروعك بأعلى جودة وأقل جهد.
            </p>
          </div>
          ...
          <div className="col-lg-3 col-md-6 col-12 p-2">
            ...
            <ul className="links_list">
              <li>الهاتف: <a href="tel:+20123456789">+20 123 456 789</a></li>
              <li>الإيميل: <a href="mailto:support@example.com">support@example.com</a></li>
              <li>العنوان: <a href="https://www.google.com/maps">جدة,السعودية</a></li>
            </ul>
          </div>

          <div className="col-12">
            <div className="copyright">
              <p>جميع الحقوق محفوظة © {new Date().getFullYear()} إلى <span>تسامي</span></p>
