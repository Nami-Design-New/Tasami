...
//       // --------------------------
//       //  IMAGE WITH UPLOAD STATE
//       // --------------------------
//       case "image":
//         return (
//           <div className="message__content-wrapper">
//             <div
//               className="message__image-container p-2"
...
//       // --------------------------
//       //  VIDEO WITH UPLOAD STATE
//       // --------------------------
//       case "video":
//         return (
//           <div className="message__content-wrapper">
//             <div
//               className="message__video-container p-2"
//               style={{ position: "relative" }}
//             >
//               {isUploading ? (
//                 // Show uploading state
...
//                     </svg>
//                     <div style={{ fontSize: "14px" }}>Uploading video...</div>
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ fontSize: "12px" }}>
                      {isServerPending ? "Sending..." : "Uploading..."}
                    </div>
                    <div style={{ fontSize: "14px", fontWeight: "500" }}>
                      {uploadProgress}%
                    </div>
                    ...
                    >
                      <div
                        ...
                        style={{
                          width: `${uploadProgress}%`,
                          backgroundColor: isServerPending
                            ? "#28a745"
                            : "#5fcafa",
                        }}
                        aria-valuenow={uploadProgress}
