      ...
      <div ref={pdfRef} className="performance-report">
          ...
          {performanceReportData?.all_contracts?.packages.map((item) => (
            <>
              <ReportCard
                ...
                cardNumber={1}
                title={` ${t(
                  "dashboard.reports.contractTab.helpersContractsCount"
                )} ${item.package_name}`}
        ...
        <div className="metrics-container mt-4">
          ...
          {performanceReportData?.all_contracts?.packages.map((item) => (
            <>
              <ReportCard
                ...
                cardNumber={1}
                title={`${t(
                  "dashboard.reports.contractTab.helpersWorkingContractsCount"
                )} ${item.package_name}`}
          ...
          <ReportCard
            ...
            percentage={
              performanceReportData?.all_contracts?.growth_rate_working
            }
          />
        </div>
        <div className="metrics-container mt-4">
          ...
          {performanceReportData?.all_contracts?.packages.map((item) => (
            <>
              <ReportCard
                ...
                cardNumber={1}
                title={` ${t(
                  "dashboard.reports.contractTab.helpersCompletedContractsCount"
                )} ${item.package_name}`}
        ...
        <div className="metrics-container">
            ...
            (item) => (
              <>
                <ReportCard
                  ...
                  cardNumber={1}
                  title={`${t(
                    "dashboard.reports.contractTab.requestsWorkingContractsCount"
                  )} ${item.package_name}`}
                  value={item.contracts_working_count}
                  percentage={item.percent_working}
                  shape={true}
            ...
            (item) => (
              <>
                <ReportCard
                  ...
                  cardNumber={3}
                  title={`${t(
                    "dashboard.reports.contractTab.requestsWeeklyChange"
                  )} ${item.package_name}`}
                  percentage={item.percent_of_contracts}
                  shape={true}
                />
          ...
          <ReportCard
            ...
            value={
              performanceReportData?.contracts_from_requests?.total_stopped
            }
          />
        </div>
        ...
        <div className="metrics-container">
          <ReportCard
            ...
            value={
              performanceReportData?.contracts_from_offers?.total_contracts
            }
          />
          {performanceReportData?.contracts_from_offers?.packages.map(
            (item) => (
              <>
                <ReportCard
                  langDir={langDir}
                  cardNumber={1}
                  title={`${t(
                    "dashboard.reports.contractTab.offersWorkingContractsCount"
                  )} ${item.package_name}`}
                  value={item.contracts_working_count}
                  percentage={item.percent_working}
                  shape={true}
            ...
            (item) => (
              <>
                <ReportCard
                  ...
                  cardNumber={3}
                  title={`${t(
                    "dashboard.reports.contractTab.offersWeeklyChange"
                  )} ${item.package_name}`}
                  percentage={item.percent_of_contracts}
                  shape={true}
                />
          ...
          <ReportCard
            ...
            value={
              performanceReportData?.contracts_from_offers?.total_completed
            }
          />
          <ReportCard
            langDir={langDir}
        ...
        <div className="metrics-container">
          <ReportCard
            ...
            highlight
          />
          {performanceReportData?.total_contracts_money?.packages.map(
            (item) => (
              <>
                <ReportCard
                  langDir={langDir}
                  cardNumber={1}
                  title={` ${t(
                    "dashboard.reports.contractTab.helpersTotalValue"
                  )} ${item.package_name}`}
          ...
          <ReportCard
            ...
            cardNumber={3}
            title={t(
              "dashboard.reports.contractTab.weeklyChangeHelpOffersValue"
            )}
            percentage={
            ...
            (item) => (
              <>
                <ReportCard
                  ...
                  cardNumber={3}
                  title={`${t(
                    "dashboard.reports.contractTab.helpersAverageValue"
                  )} ${item.package_name}`}
